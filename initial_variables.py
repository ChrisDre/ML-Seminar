...
df_no_labels = pd.read_stata("data/GSS7218_R1_2018.dta", convert_categoricals=False)

# get all data from 2018 with labels (dropped before: hhtype, ISCO08, PAISCO08, MAISCO08, SPISCO08)
df_labels = pd.read_stata("data/GSS7218_R1_2018.dta", convert_categoricals=True)
...
df_no_labels.to_pickle("data/gss_2018_no_labels.pkl")
df_labels.to_pickle("data/gss_2018_labels.pkl")
